...
$JSDOC -u ./tutorials -c jsdoc-conf.json --lenient -d $D/core mljs.js ./lib/basic-wrapper.js ./lib/digest-wrapper.js ./lib/noop.js ./lib/passthrough-wrapper.js core.md
echo "...done."
echo "Generating widget documentation..."
$JSDOC -u ./tutorials -c jsdoc-conf.json --lenient -d $D/widgets ./mldbwebtest/src/public/js/mljs/mljs-*.js ./mldbwebtest/src/public/js/mljs/widget*.js browser.md
echo "...done."
