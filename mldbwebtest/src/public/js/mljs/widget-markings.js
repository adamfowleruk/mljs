...
com.marklogic.widgets.markings.prototype._init = function() {
  ...
  var html = "<div id='" + id + "'>" +
      "<div id='" + id + "-docinfo' class='markings-docinfo'>&nbsp;</div>" +
      "<div id='" + id + "-doccontent' class='markings-doccontent'>&nbsp;</div>" +
    "</div>";
...
com.marklogic.widgets.markings.prototype.showDocument = function(uri) {
  ...
  // Show meta information
    s += "<h2 class='markings-meta-title'>Document Extracted Metadata</h2> <table class='markings-meta-table'><tr>";
    ...
    s += "<h2 class='markings-security-title'>Document Security Information</h2> <div class='markings-security-rolecontainer'>";
    ...
    var divs = null;
    var content = "<h2 class='markings-content-title'>Document Secure Content</h2>";
    ...
    for (var d = 0;d < divs.length;d++) {
      ...
      content += "<div class='markings-content-section-html'>";
