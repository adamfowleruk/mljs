...
window.onload = function() {
  ...
  ctx.register(bar);
  var scope = angular.element(document.getElementById("appwrapper"));
  var ctl = scope.controller();
  ctx.register(ctl); // links to angular js page controller - could do this at a lower level though
